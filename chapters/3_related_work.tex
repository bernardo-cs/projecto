...
\subsubsection{The Geo-Som Approach} % (fold)
\label{ssub:types_of_soms}

%%%
%%% Removed for lack of interest... Maybe add back to the basic concepts???
%%%
...
%%% Removed for lack of interest... Maybe add back to the basic concepts???
%%%
% Self organizing maps have their own limitations mainly drawing from the fact that it has a fixed number of neurons. ~\citet{Qiang2010} cites in his survey about the state of self organizing maps, that newer algorithms namely Gcolumning cell Structures ~\cite{Fritzke1995} and Gcolumning Neural Gas ~\cite{Fritzke1994} don't have this drawback.
...
%%%
%%% Removed until example is written
%%%
